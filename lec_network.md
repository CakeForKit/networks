...
## Время жизни
ttl - time to live
(windows - 128, linux 255)

**Протокол**
 код протокола которому необзодимо передать содержимое поле данных (кому надо деинкапсулировать)

**Контрольная сумма заголовка**
констрольная сумма, данные не проверяет

**Опции**
Поле модет отсутсвовать в заголовке.

Опции делятся на 4 класс, 1 и 3 зарезервированые
0 - 
2 - дейтаграмма пользователя
...
1. ручное зназначение статических адресов
2. динамическое назначение статических адресов
Задаем пул адресов, или начальный ip и их количество


2 алгоритма безклассовой адресации
1. VLSM (маска переменной длины)
2. CIDR 

VLSM
ip состоит из: адрес сети, адрес подсети, адрес хоста
...
Задача 1
разбить на 7 подсетей адрес 5го хоста первой подсети
...
192.168.1.0/24
max подсетей
min 7 хостов в каждой
образ 5 хостов в 1 подсети

192.168.1.0000 0000
192.168.1.1111  маска
192.168.1.


макс подсетей min 6 хостов в котором широковещательный адрес подсети
6 хостов  - 3 последних бита
маска .1111 
/27
192.168.1.00010111
192.168.1.23/29
...
172.16.0.0.16
макс подсетей
min 347 хостов в каждой
адрес 37 хоста в 1 подсети

9 посдедних бит
172.16.2.37/23

172.16.27.0/20
макс подсетей, мин 250 хостов в подсети, широковещательный адрес 3 подсети
